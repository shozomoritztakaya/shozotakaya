...
showcase:
  ...
  description: "I work at <a target='_blank' href='https://www.cloudflare.com/'>Cloudflare</a>, one of the world’s largest networks which focuses on security, performance, and reliability, and on a mission to help build a better Internet."
  image:
  ...
  socialLinks:
    - icon: "linkedin"
      URL: "https://www.linkedin.com/in/shozo-moritz-takaya-655696128/"
...
about:
  ...
  content: '<p class="lead">
   Ich bin Shozo und baue diese Webseite, um unsere Cloudflare-Lösungen zu testen.
    </p>
    <p class="lead">
    test test test.
    </p>'
...
client_and_work:
  ...
  works:
    - title: "cloudflare Finance - UI Kit"
      ...
      button:
        ...
        URL: "#"
      image:
        x: "img/works/cloudflare-finance.jpg"
        _2x: "img/works/cloudflare-finance@2x.jpg"
      is_even: true
...
contact:
  ...
  email:
    title: "Email"
    email: '<a href="mailto:team@cloudflare.com">team@cloudflare.com</a>'
  address:
    title: "Address"
    address: "Cloudflare GmbH<br />Rosental 7, 80331 Munich"

  socialmedia:
    title: "Social Media"
    linkedin: "https://www.linkedin.com/company/cloudflare/"
    facebook: "https://www.linkedin.com/company/cloudflare/"
    instagram: "https://www.linkedin.com/company/cloudflare/"
    twitter: "https://www.linkedin.com/company/cloudflare/"
  # button:
  #   icon: "icon-mail-fill"
